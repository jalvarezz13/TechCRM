...
public class ContactoSQLiteHelper extends SQLiteOpenHelper {
    ...
    String sqlCrearTabla = "CREATE TABLE Contactos(nombre TEXT, npedidos INT, tlf TEXT, tip INT, email TEXT, direccion TEXT)";

    public ContactoSQLiteHelper(Context contexto, String nombreBD, SQLiteDatabase.CursorFactory factory, int versionBD) {
